...
const DecorativeBackgroundFull = () => {
  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10">
      ...
      <div className="absolute top-[8%]  left-[4%]  w-80 h-80 rounded-full bg-mint-light/70  blur-[80px]" />
      <div className="absolute top-[55%] right-[8%] w-64 h-64 rounded-full bg-blush-light/75  blur-[70px]" />
      <div className="absolute bottom-[10%] left-[28%] w-72 h-72 rounded-full bg-olive-light/65 blur-[75px]" />
      <div className="absolute top-[25%] right-[22%] w-56 h-56 rounded-full bg-beige-warm/70  blur-[65px]" />
      <div className="absolute top-[42%] left-[48%] w-44 h-44 rounded-full bg-gold-light/55   blur-[60px]" />
...
export default DecorativeBackgroundFull;
